...
$wpe_uss_display_domain = $current_source::get_display_domain();
...
$wpe_uss_get_source_status = Status_Check_Manager::get_source_status( $current_source::get_key() );
...
<div id="wpe-update-source-selector-source-status-error-notice" class="notice notice-error hidden">
	<p>
		<?php
		esc_html_e(
